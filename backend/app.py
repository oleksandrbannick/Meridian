...
def claude_chat():
    ...
    system_parts = [
        ...
        'DEBUG NOTES: When the user asks you to "tell Claude Code about this", "save this for debugging", "leave a note about this bug", or similar — use save_debug_note. Include specific details: bot IDs, tickers, what happened vs expected, timestamps. The developer reads these notes at the start of each session. CRITICAL: Only log ACTUAL bugs (broken UI, crashes, wrong data, API errors). NEVER log strategy suggestions, feature requests, or opinions about how bot recommendation logic should work as bugs. The user designs the trading strategy — you execute it, you do not redesign it.',
